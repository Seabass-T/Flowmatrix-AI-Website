    ...
    <div className="bg-black min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-4">Terms and Conditions - FlowMatrix AI</h1>
          ...
          <div className="bg-card border border-border p-6 rounded-lg mb-8">
            <h2 className="text-xl font-semibold text-white mb-3">Welcome to FlowMatrix AI</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
              FlowMatrix AI provides specialized automation and AI implementation services for businesses ready to move faster than their competition.
              Our services help organizations streamline operations, reduce manual work, and increase efficiency through custom AI-powered automation solutions.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              These Terms and Conditions govern your use of our services, including our transformation process,
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-white mb-4">3. Ownership and Code Transfer Limitations</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-white mb-4">4. Payment Structure</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-white mb-4">5. Third-Party Platform Disclaimers</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
