    ...
    <div className="bg-background">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-slate max-w-none dark:prose-invert">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-foreground mb-4">3. Ownership and Code Transfer Limitations</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-foreground mb-4">4. Payment Structure</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-foreground mb-4">5. Third-Party Platform Disclaimers</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
