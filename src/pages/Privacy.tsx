    ...
    <div className="bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Privacy Policy - FlowMatrix AI Toronto</h1>
          ...
          <div className="bg-muted p-6 rounded-lg mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-3">Your Privacy Matters to Us</h2>
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-3">Service Delivery</h3>
            <ul className="list-disc list-inside text-gray-600 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-3">Analytics and Improvement</h3>
            <ul className="list-disc list-inside text-gray-600 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-3">Communication (Optional Marketing)</h3>
            <ul className="list-disc list-inside text-gray-600 space-y-2 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">3. Third-Party Tools and Data Processing</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              To deliver our services effectively, we integrate with various third-party platforms that may process your data:
            </p>
            
            <h3 className="text-xl font-medium text-gray-900 mb-3">Automation and Integration Platforms</h3>
            <ul className="list-disc list-inside text-gray-600 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-3">Infrastructure and Data Storage</h3>
            <ul className="list-disc list-inside text-gray-600 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-3">AI and Analytics Services</h3>
            <ul className="list-disc list-inside text-gray-600 space-y-2 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">4. Data Storage and Protection</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-3">Access and Portability</h3>
            <ul className="list-disc list-inside text-gray-600 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-3">Correction and Deletion</h3>
            <ul className="list-disc list-inside text-gray-600 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-3">Marketing and Communication Preferences</h3>
            <ul className="list-disc list-inside text-gray-600 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-3">GDPR and CCPA Compliance</h3>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-3">Data Deletion Requests</h3>
            <p className="text-gray-600 leading-relaxed mb-4">
