      ...
      <div className="bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen">
        ...
        <div className="text-center mb-12 relative border border-gray-200 rounded-2xl p-8 bg-white/50 backdrop-blur-sm shadow-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
            ...
            <Link to="/use-cases/specialized-agents" className="col-span-2 md:col-span-3 lg:col-span-4 block p-4 bg-gradient-to-r from-purple-600 via-pink-500 to-orange-500 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-2 border-purple-200 hover:border-orange-300">
              <div className="text-center">
                <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center mx-auto mb-3 backdrop-blur-sm">
                  <Building2 className="h-6 w-6 text-white" />
                </div>
                <h3 className="font-semibold text-white drop-shadow-sm">Specialized AI Agents</h3>
              </div>
            </Link>
