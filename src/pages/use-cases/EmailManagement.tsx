              ...
              <div className="space-y-4">
                <div className="border-l-4 border-blue-500 pl-4">
                  <h4 className="font-semibold text-gray-900 mb-2">
                    <a 
                      href="https://www.radicati.com/?p=17941" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="text-blue-600 hover:text-blue-800 flex items-center gap-2"
                    >
                      Email Statistics – Radicati Group <ExternalLink className="h-4 w-4" />
                    </a>
                  </h4>
                  <p className="text-gray-600">The average office worker sends/receives over 120 emails per day, creating massive inefficiencies without automation.</p>
                </div>
                
                <div className="border-l-4 border-green-500 pl-4">
                  <h4 className="font-semibold text-gray-900 mb-2">
                    <a 
                      href="https://www.mckinsey.com/industries/technology-media-and-telecommunications/our-insights/the-social-economy?utm_source=chatgpt.com" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="text-green-600 hover:text-green-800 flex items-center gap-2"
                    >
                      McKinsey Productivity Study <ExternalLink className="h-4 w-4" />
                    </a>
                  </h4>
                  <p className="text-gray-600">Employees spend <strong>28% of their workweek</strong> on email—automation can significantly cut this time.</p>
                </div>
                
                <div className="border-l-4 border-purple-500 pl-4">
                  <h4 className="font-semibold text-gray-900 mb-2">
                    <a 
                      href="https://go.forrester.com/blogs/why-customer-service-email-response-times-matter/?utm_source=chatgpt.com" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="text-purple-600 hover:text-purple-800 flex items-center gap-2"
                    >
                      Forrester Research – Customer Experience Impact <ExternalLink className="h-4 w-4" />
                    </a>
                  </h4>
                  <p className="text-gray-600">Faster and more consistent email response times lead directly to higher customer satisfaction and retention.</p>
                </div>
                
                <div className="border-l-4 border-orange-500 pl-4">
                  <h4 className="font-semibold text-gray-900 mb-2">
                    <a 
                      href="https://www.statista.com/statistics/1239712/marketing-automation-email-roi-worldwide/?utm_source=chatgpt.com" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="text-orange-600 hover:text-orange-800 flex items-center gap-2"
                    >
                      Statista – Email Automation ROI <ExternalLink className="h-4 w-4" />
                    </a>
                  </h4>
                  <p className="text-gray-600">Email automation generates one of the <strong>highest ROIs in digital marketing</strong>, returning an average of $42 for every $1 spent.</p>
                </div>
              </div>
            </section>
